...
_Generated: 2026-07-06T09:35:44.274Z_
...
Workspace `mcp.json` _(folder: product-management)_

- **d:\spring_workspace\product-management\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\laksh\AppData\Roaming\Code\User\mcp.json** — _File missing_
