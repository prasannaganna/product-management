package com.st.productmanagement.security;
...
public class JwtUtil {
    private static final String TOKEN_ISSUER = "product-management";
    private static final String ROLE_TAG = "roles";
    private static final String ISSUED_DATE_TAG = "issuedDate";
